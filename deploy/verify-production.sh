...
readonly EXPECTED_ANDROID_APK_SHA256="6f4156d6cf24df27b95b6cc53b26f83bd965c266da144e04f6feb3ccb884f156"
...
[[ "$(sha256sum "${AMIGO_ANDROID_APK}" | awk '{ print $1 }')" \
    ...
    || amigo_die "installed Android update hash differs from signed 1.3.3"
...
amigo_log "PASS database-owned originals, repaired laboratory dates, bounded analyte-guide backfill progress, and signed Android 1.3.3 artifact"
...
if contract == "session":
    ...
    if (
        payload.get("version_code") != 13
        or payload.get("version_name") != "1.3.3"
        or payload.get("sha256") != "6f4156d6cf24df27b95b6cc53b26f83bd965c266da144e04f6feb3ccb884f156"
