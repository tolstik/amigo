...
describe("API normalization", () => {
  ...
  it.each(["weekly", "monthly"] as const)("normalizes continuous %s plan and fact buckets including gaps", (period) => {
    const result = normalizeWeightSeries({
      ...
      [period]: [
        ...
        },
        {
          ...
          planned_start_kg: 126.901,
          planned_to_date_kg: 126.127,
          planned_end_kg: 125.998,
          planned_full_change_kg: -0.903,
          actual_start_date: "2026-08-17",
          actual_end_date: "2026-08-20",
          actual_start_kg: 126.5,
          actual_end_kg: 126,
          planned_observed_change_kg: -0.387,
        },
      ],
    }, "program");
    ...
    expect(result[period][0]).toMatchObject({
      ...
      plannedStartKg: 126.901,
      plannedToDateKg: 126.127,
      plannedEndKg: 125.998,
      plannedFullChangeKg: -0.903,
      actualStartDate: "2026-08-17",
      actualEndDate: "2026-08-20",
      actualStartKg: 126.5,
      actualEndKg: 126,
      plannedObservedChangeKg: -0.387,
    });
