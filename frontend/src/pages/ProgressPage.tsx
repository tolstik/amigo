        ...
        <>
          ...
          {series.data.monthly.length ? (
            <ChartCard
              ...
              height={390}
              footer={<>
                <p className="chart-note">Среднее дневных медиан без выбросов. Первый месяц сравнивается со стартовым весом программы: {formatKg(plan?.startWeightKg, 2)}. Текущий месяц — по сегодня; план усреднён за те же дни. После месяца без замеров изменение не рассчитывается. Зелёный — план выполнен, жёлтый — темп ниже плана, коралловый — снижения нет.</p>
